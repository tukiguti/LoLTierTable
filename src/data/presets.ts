...
export const LANE_PRESETS: Record<Lane, readonly string[]> = {
  TOP: [
    ...
    'Jayce', 'KSante', 'Kayle', 'Kled', 'Malphite', 'Maokai', 'Mordekaiser', 'Nasus',
    'Olaf', 'Ornn', 'Pantheon', 'Poppy', 'Quinn', 'Renekton', 'Riven', 'Rumble',
    'Sett', 'Shen', 'Singed', 'Sion', 'TahmKench', 'Teemo', 'Trundle', 'Tryndamere',
    'Udyr', 'Urgot', 'Vayne', 'Vladimir', 'Volibear', 'Warwick', 'Yasuo', 'Yone',
    'Yorick', 'Zaahen',
  ],
  JG: [
